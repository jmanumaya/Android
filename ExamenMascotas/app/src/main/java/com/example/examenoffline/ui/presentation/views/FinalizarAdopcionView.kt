...
@Composable
fun FinalizarAdopcionView(navController: NavController, viewModel: MascotasViewModel, mascotaId: Int?) {
    ...
    Column(
        ...
        Text(
            "Introduce el nombre de la persona que va a adoptar al animal",
            fontSize = 24.sp,
            fontWeight = FontWeight.Bold
        )
        ...
        Button(
            onClick = {
                if (!showError) {
                    viewModel.adoptar(mascotaId, nombre)
